...
int8_t network_p2p_set_hosts(struct network_p2p *, const struct string_st *);
void network_p2p_get_hosts(const struct network_p2p *, struct string_st *);
int8_t network_p2p_connected(struct network_p2p *);

int8_t network_p2p_get(struct network_p2p *, const struct string_st *, struct string_st *);
int8_t network_p2p_send(struct network_p2p *, const struct string_st *);

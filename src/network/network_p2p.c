...
int8_t network_p2p_set_hosts(struct network_p2p *res, const struct string_st *tlv) {
...
int8_t network_p2p_connected(struct network_p2p *res) {
    return network_server_connected(&res->server);
}

int8_t network_p2p_get(struct network_p2p *res, const struct string_st *msg, struct string_st *res_msg) {
    return network_server_get(&res->server, msg, NET_DATA, res_msg);
}
int8_t network_p2p_send(struct network_p2p *res, const struct string_st *msg) {
